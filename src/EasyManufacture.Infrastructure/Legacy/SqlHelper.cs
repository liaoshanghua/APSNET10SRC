    ...
    public sealed class SqlHelper
    {
        ...
        public static string MSSQLConnectionString
        {
            get
            {
                ...
                {
                    mssqlConnectionString = LegacyRuntime.ConnectionString;
                }
                return mssqlConnectionString;
            }
        }
        private static string mssqlConnectionStringScm = "";
        public static string MSSQLConnectionStringSCM
        {
            get
            {
               
                if (string.IsNullOrEmpty(mssqlConnectionStringScm))
                {
                    mssqlConnectionStringScm = LegacyRuntime.ConnectionStringScm;
                }
                return mssqlConnectionStringScm;
            }
        }
        /// <summary> 
        /// 执行内置数据库查询的命令,返回DataTable. 
        /// </summary> 
        /// <remarks> 
        /// 示例:  
        ///  DataTable dt = ExecuteDataset(commandText); 
        /// </remarks> 
        ...
        public static DataTable ExecuteDataTable(string commandText)
        {
            ...
            DataSet ds = ExecuteDataset(MSSQLConnectionString, CommandType.Text, commandText);
            DataTable dt = null;
        ...
        /// <returns></returns>
        public static string GetKeyValue(string tableName, string primaryName, string appCode)
        {
            SqlParameter[] sqlParameters = new SqlParameter[4];
            sqlParameters[0] = new SqlParameter("@TableName", tableName);
            sqlParameters[1] = new SqlParameter("@FieldName", primaryName);
            sqlParameters[2] = new SqlParameter("@AppCode", appCode);
            sqlParameters[3] = new SqlParameter("@billno", SqlDbType.VarChar, 20);
            sqlParameters[3].Direction = ParameterDirection.Output;
            ExecuteNonQuery(MSSQLConnectionString, "P_GetKeyValue", sqlParameters);
            return sqlParameters[3].Value.ToString();
        }
        ...
        {
            return ExecuteNonQuery(MSSQLConnectionString, CommandType.Text, commandText);
        }
        public static int ExecuteNonQuery(string commandText, params SqlParameter[] commandParameters)
        {
            return ExecuteNonQuery(MSSQLConnectionString, CommandType.Text, commandText, commandParameters);
        }
        /// <summary>  
        ...
        /// <param>存储过程名称或T-SQL语句</param>  
        /// <returns>返回影响的行数/returns>  
        public static long ExecuteNonQuery(SqlTransaction transaction, CommandType commandType, string commandText)
        {
        ...
        /// <param>SqlParamter参数数组</param>  
        /// <returns>返回影响的行数</returns>  
        public static long ExecuteNonQuery(SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
          ...
          //  systemLog.SaveLog(SystemLog.SystemLogType.SQL更新, commandText, null, commandParameters);
            // 执行  
            ...
            try
            {
                ...
                {
                    retval = long.Parse(tmp.ToString());
                }
            }
            catch (Exception ex)
            { }
        ...
        /// <param>分配给存储过程输入参数的对象数组</param>  
        /// <returns>返回受影响的行数</returns>  
        public static long ExecuteNonQuery(SqlTransaction transaction, string spName, params SqlParameter[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        public static DataSet ExecuteDataset(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter(cmd))
            {
               ...
               // if (mustCloseConnection)
                ...
                {
                    //systemLog.SaveLog(SystemLog.SystemLogType.SQL查询, commandText, null, null);
                }
                else
                {
                   // systemLog.SaveLog(SystemLog.SystemLogType.SQL存储过程查询, commandText, null, null);
                }
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    for (int i = 0; i < dt.Columns.Count; i++)
                    {
                        ...
                        if (info != null)
                        {
                            ...
                            {
                                info.SetValue(s, Convert.ToString(item[i]), null);
                            }
                        }
                    }
                    list.Add(s);
        ...
        /// <param>使用DataRow作为参数值</param>  
        /// <returns>返回影响的行数</returns>  
        public static long ExecuteNonQueryTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
